...
- `target_market_order_books`, `target_market_trades`, `target_market_tickers` を MM 対象 venue market fact として保存すること
- `external_market_top_of_book`, `external_market_tickers`, `external_market_trades` を外部 CEX market fact として保存すること
...
- market-data recorder と external-market recorder は bot data を書かないこと
